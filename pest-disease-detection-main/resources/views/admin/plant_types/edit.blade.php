                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header" style="background-color: rgb(102, 170, 102)">
                            <h3 class="card-title">Edit Plant Type</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('plant_types.update', $plantType->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-form-label" for="inputSuccess">Edit Plant Type</label>
                                    <input type="text" name="type" class="form-control input-border"
