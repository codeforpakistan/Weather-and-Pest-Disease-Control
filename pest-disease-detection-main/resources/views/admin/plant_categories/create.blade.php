                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header" style="background-color: rgb(102, 170, 102)">
                            <h3 class="card-title">New Plant Category</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('plant_categories.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-form-label" for="inputSuccess">Plant Category</label>
                                    <input type="text" name="category" class="form-control input-border" placeholder="Enter plant category">
                                </div>
                            </div>
                            <!-- /.card-body -->
