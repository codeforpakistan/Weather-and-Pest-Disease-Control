    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box text-white" style="background-color: rgb(102, 170, 102)">
                        <div class="inner">
                            <h3>5</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="{{ asset('dist/img/user1-128x128.jpgs') }}"
